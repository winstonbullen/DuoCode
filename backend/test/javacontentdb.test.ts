...
describe("Content Atlas DB", () => {
  ...
  */
  ...
  it("reads the first drag & drop java arrays question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java classes question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java collections question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java conditions question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java loops question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java methods question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java operators question of difficulty one", async () => {
  ...
  it("reads the first drag & drop java variables question of difficulty one", async () => {
  ...
  */
  ...
  it("reads the first drag & drop java variables question of difficulty two", async () => {
  ...
  it("reads the first drag & drop java variables question of difficulty three", async () => {
  ...
  */
  ...
  it("reads the first multiple choice java variables question of difficulty one", async () => {
  ...
  it("reads the first short response java variables question of difficulty one", async () => {
  ...
  */
  ...
  it("reads the first short response java loops question of difficulty three", async () => {
  ...
  it("reads the first drag & drop java operators question of difficulty two", async () => {
  ...
  it("reads the first multiple choice java collections question of difficulty three", async () => {
