...
const emptyShortAnswer: shortAnswerData = {
    language: '',
    subject: '',
    type: '',
    difficulty: 0,
...
const ShortAnswer: React.FC<ShortAnswerProps> = ({updateSolution, submitRef, language, unit, difficulty, handleAnsweredCorrectly}) => {
     ...
     */
    const [shortAnswer, setshortAnswer] = useState<shortAnswerData>(emptyShortAnswer);
    /**
     * Tracks text written.
     */
     ...
     */
    useEffect(() => {
        updateSolution(shortAnswer.correct_answer)
        // eslint-disable-next-line react-hooks/exhaustive-deps
    }, [shortAnswer]);
    ...
    const validateAnswer = () => {
        return text.toLowerCase() === shortAnswer.correct_answer.toLowerCase();
    };
            ...
            <div className="short-answer-container">
                {shortAnswer && (
                    <form onSubmit={handleSubmit}>
                        <label htmlFor="short-answer-input" className="short-answer-prompt">{shortAnswer.prompt}</label>
                        <br></br>
